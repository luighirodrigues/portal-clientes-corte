...
async function main() {
  ...
  // 1. Criar Admin inicial apenas se não existir
  ...
  if (!existingAdmin) {
    ...
    console.log('Admin inicial configurado:', admin.email);
  } else {
    console.log('Admin já existente, preservando credenciais atuais.');
  }
